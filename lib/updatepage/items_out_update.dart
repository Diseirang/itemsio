...
class UpdateItemsOutRecord extends StatefulWidget {
  const UpdateItemsOutRecord({Key? key, required this.ItemsOutKey})
      : super(key: key);
  final String ItemsOutKey;

  @override
  State<UpdateItemsOutRecord> createState() => _UpdateItemsOutRecordState();
}

class _UpdateItemsOutRecordState extends State<UpdateItemsOutRecord> {
  ...
  void getItemsINData() async {
    DataSnapshot snapshot = await dbRef.child(widget.ItemsOutKey).get();
